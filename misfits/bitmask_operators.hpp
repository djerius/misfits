...
template<typename E>
typename boost::enable_if_c<enable_bitmask_operators<E>::enable,E>::type
operator|(E lhs,E rhs){
    typedef typename boost::underlying_type<E>::type underlying;
    return boost::underlying_cast<E>(
        boost::underlying_cast<underlying>(lhs) | boost::underlying_cast<underlying>(rhs));
}
...
operator~(E lhs){
    typedef typename boost::underlying_type<E>::type underlying;
    return boost::underlying_cast<E>(
        ~boost::underlying_cast<underlying>(lhs));
}
